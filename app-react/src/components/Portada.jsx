  ...
  return (
    <div className="w-[1080px] h-[1920px] bg-[#0032A0] flex flex-col items-center absolute inset-0">
      ...
      <div className="flex flex-col items-center gap-5 px-20 pt-12">
        <h1 className="font-sg-bi15 text-[60px] leading-[1.1] text-white text-center">
          ¿Cuánto sabes de construcción?
        </h1>
        <p className="font-sg-b15 text-[36px] text-white/70 text-center">
      ...
      <div className="flex flex-col items-center pb-20 gap-10">
        ...
        >
          <span className="font-sg-mi10 text-[40px] text-[#0032A0] tracking-[2px]">INICIAR</span>
        </button>
